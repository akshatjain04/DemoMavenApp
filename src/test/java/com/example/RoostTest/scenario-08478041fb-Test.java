...
public class scenario_08478041fb_Test {

    @Test
    public void CreatePetWithBody() {
        // Fetch the environment variables and assign them to global variables
        String domainName = System.getenv("API_HOST");
        String csvFilePath = "src/test/java/com/example/RoostTest/scenario-08478041fb-Test.csv";
        ...
        try {
            ...
            while ((line = lineReader.readLine()) != null) {
                ...
                if (lineNumber > 2) {
                    ...
                    String[] objectList = line.split("\\^\\|\\^");
                    String method = objectList[0];
                    String URL = objectList[1];
                    String REQ_HEADERS = objectList[2];
                    String REQ_BODY = objectList[3];
                    int RESPONSE_CODE = Integer.parseInt(objectList[4]);
                    String RESPONSE_BODY = objectList[5];

                    JSONObject requestHeaders = new JSONObject((java.util.Map) Arrays.asList(REQ_HEADERS.split(",")));
                    JSONObject requestBody = new JSONObject((java.util.Map) Arrays.asList(REQ_BODY.split(",")));
