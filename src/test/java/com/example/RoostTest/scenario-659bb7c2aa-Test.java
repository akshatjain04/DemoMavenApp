...
public class scenario659bb7c2aaTest {
    ...
    public void init() throws IOException {
        String file = "src" + System.getProperty("file.separator")
    ...
    public void testCreatePet() throws IOException {
        ...
        while ((line = bufferedReader.readLine()) != null) {
            ...
            Map<String, String> headers = gson.fromJson(arr[2], new TypeToken<Map<String, String>>(){}.getType());
            Map<String, Object> payload = gson.fromJson(arr[3], new TypeToken<Map<String, Object>>(){}.getType());
            int responseCode = Integer.parseInt(arr[4]);
            Map<String, Object> responseBody = gson.fromJson(arr[5], new TypeToken<Map<String, Object>>(){}.getType());
            if(method.equals("POST")) {
                ...
                for(String key: responseBody.keySet()) {
                    response.then().assertThat().body(key, is(responseBody.get(key)));
                }
            }
        }
    }
