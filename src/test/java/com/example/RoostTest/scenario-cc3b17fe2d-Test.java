...
public class ScenarioCc3b17fe2dTest {
    ...
    public static void setup() {
        ...
        Path filePath = FileSystems.getDefault().getPath("src", "test", "java", "com", "example", "RoostTest", "scenario-cc3b17fe2d-Test.csv");
        String line = "";
        try ( BufferedReader br = new BufferedReader(new FileReader(filePath.toString()))) {
            br.readLine();
            while ((line = br.readLine()) != null) {
                String[] data = line.split("\\^\\|\\^");
                endpointUrl = data[1].split(baseUrl)[1];
                headers = Headers.headers(new Header("Content-Type", "application/json"), new Header("Authorization", data[2]));
                payload = data[3];
    ...
    @Test
    public void createPet_with_body() {
        ...
        assertThat("Checking status code", response.getStatusCode(), equalTo(expectedStatusCode));
        assertThat("Checking response time", response.getTime(), lessThan(50L));

        String responseBody = response.getBody().asString();

        assertThat("Checking response body", responseBody.contains("id"));
        assertThat("Checking response body", responseBody.contains("doggie"));
        assertThat("Checking response body", responseBody.contains("available"));
    }
}
